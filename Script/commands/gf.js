...
module.exports.run = async function ({ event, api, args }) {    
    ...
    if (!mention[0]) return api.sendMessage("Please mention 1 person.", threadID, messageID);
        ...
        return makeImage({ one, two }).then(path => api.sendMessage({ body: "✿┈┈┈┈┈┈༺♡༻┈┈┈┈┈┈✿/n     নে জোরা লাগিয়ে দিলাম!\✿┈┈┈┈┈┈༺♡༻┈┈┈┈┈┈✿\\    💑 সারাজীবন একসাথে থাকিস তরা।\    তরা একসাথে থাকলেই আমি খুশি আর কিছু চাই না আমার শুধু সারাজীবন একসাথে ভালো থাকিস", attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
    }
      }
